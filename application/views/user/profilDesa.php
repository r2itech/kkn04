<section class="hero-banner hero-banner-sm">
    <div class="hero-wrapper">
        <div class="hero-left">
            <h1 class="hero-title">Profil Desa</h1>
            <p>Desa Karangsari <br class="d-none d-xl-block"> Kecamatan Darma, Kabupaten Kuningan</p>
        </div>
            ...
            <div class="col-lg-8 posts-list">
                <div class="single-post">
                    <div class="feature-img">
                        <img class="img-fluid" src="<?= base_url('assets/img/profileDesa/') . $profile['image']; ?>" alt="profil.img">
                    </div>
                        ...
                        <ul class="list cat-list">
                            <li>
                                <a href="<?= site_url('user/profileDesaSejarah') ?>" class="d-flex">
                                    <p>Sejarah Singkat Desa</p>
                                </a>
                            </li>
                            <li>
                                <a href="<?= site_url('user/profileDesaWilayah') ?>" class="d-flex">
                                    <p>Wilayah Desa</p>
                                </a>
                            </li>
                            <li>
                                <a href="<?= site_url('user/profileDesaArtiLambang') ?>" class="d-flex">
                                    <p>Arti Lambang Desa</p>
                                </a>
                            </li>
                            <li>
                                <a href="<?= site_url('user/profileDesaStrukturOrganisasi') ?>" class="d-flex">
