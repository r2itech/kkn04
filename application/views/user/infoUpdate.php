<section class="hero-banner hero-banner-sm">
    <div class="hero-wrapper">
        <div class="hero-left">
            <h1 class="hero-title">Info Update</h1>
            <p>KKN04 UNIKU 2020 <br class="d-none d-xl-block"> Desa Karangsari, Darma</p>
        </div>
            ...
            <div class="col-lg-8 posts-list">
                <div class="single-post">
                    <div class="feature-img">
                        <img class="img-fluid" src="<?= base_url('assets/img/about/') . $about['image1']; ?>" alt="sejarah.img">
                    </div>
