<section class="hero-banner hero-banner-sm">
    <div class="hero-wrapper">
        <div class="hero-left">
            <h1 class="hero-title">Profil Wirausaha</h1>
            <p>Papikari | Pangsit Pisang Karangsari <br class="d-none d-xl-block"> Produk Unggulan Desa Karangsari </p>
        </div>
            ...
            <div class="col-lg-8 posts-list">
                <div class="single-post">
                    <div class="feature-img">
                        <img class="img-fluid" src="<?= base_url('assets/img/profileUsaha/') . $profile['image']; ?>" alt="profil.img">
                    </div>
                ...
                <div class="navigation-top">
                    <div class="d-sm-flex justify-content-between text-center">
                        ...
                        <ul class="social-icons">
                            ...
                            <li><a href="https://wordpress.com/" target="_blank"><i class="ti-wordpress"></i></a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="blog_right_sidebar">
                    ...
                    <aside class="single_sidebar_widget post_category_widget">
                        ...
                        <ul class="list cat-list">
                            ...
                            <li>
                                <a href="<?= site_url('user/profileUsahaAlamat') ?>" class="d-flex">
                                    <p>Alamat Perusahaan</p>
                                </a>
                            </li>
                            <li>
                                <a href="<?= site_url('user/profileUsahaArtiLambang') ?>" class="d-flex">
                                    <p>Arti Lambang Perusahaan</p>
                                </a>
                            </li>
                            <li>
                                <a href="<?= site_url('user/profileUsahaStrukturOrganisasi') ?>" class="d-flex">
